...
%------------------------------------------------------------------------------
function Setting_ES_pButton_Callback(hObject, eventdata, ES_Tool_Kit_FigH)

handles = guidata(ES_Tool_Kit_FigH);
% Create a figure with no manu bar and no tool bar. The window title is Auto Fit Settings
Setting_FigureH = figure('Name','Elementary Spectra Settings','NumberTitle','off', ...
...
ES_Setting_Tab              = uitab(tabgp,'Title','ES');
handles.ES_Setting_Tab      = ES_Setting_Tab; guidata(hObject, handles);
%-------------------------- Plot Setting Tab --------------------------------------------------------------------------
...
% handles = General_Setting_Tab_Fcn(handles);
handles = ES_Setting_Tab_Fcn(hObject, eventdata);
