...
Main_Console = figure('Name','FRET Spectrometry Suite', 'Tag','Main_Console', 'Position',[700, 50, 170, 750], 'Menubar','none', ...
...
About_Menu = uimenu(Main_Console, 'Label', 'About', 'Callback', {@About_Menu_Callback});
handles.About_Menu = About_Menu;
...
eSpect_pButton         = uicontrol('Parent',Main_Console, 'Tag','eSpect_pButton', ...
                                   ...
                                   'Position',[21, 608, Button_length, Button_Height], 'Units','pixels',...
...
FICoS_Calc_pButton = uicontrol('Parent',Main_Console, 'Tag','FICoS_Calc_pButton', ...
                               'Style','pushbutton',...
                               'cdata',FICoS_Calc_Icon_Image, 'TooltipString','FRET Calculator', ...
...
[MetaHist_Gui_Icon_Image, ~] = imread('.\Icons\Metahist_snapshot_2.png');
MetaHist_Gui_pButton = uicontrol('Parent',Main_Console, 'Tag','FICoS_Calc_pButton', ...
                               'Style','pushbutton',...
                               'cdata',MetaHist_Gui_Icon_Image, 'TooltipString','Meta-histogram plot', ...
                               'Position',[21, 21, Button_length, Button_Height], 'Units','pixels',...
                               'Visible','on', 'FontSize',10,...
                               'Callback',{@Metahist_gui});
handles.MetaHist_Gui_pButton = MetaHist_Gui_pButton;
