...
%------------------------------------------------------------------------------
function Setting_pButton_Callback(hObject, eventdata, FRET_FigureH)
...
handles = General_Setting_Tab_Fcn(handles); guidata(handles.output, handles);
handles = FRET_Setting_Tab_Fcn(FRET_FigureH); guidata(handles.output, handles);
