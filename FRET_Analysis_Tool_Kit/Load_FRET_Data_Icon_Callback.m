function Load_FRET_Data_Icon_Callback(hObject, eventdata)
...
switch File_Type
    ...
    case 'mfrt'
        ...
        if isfield(FRET_Data_Struct, 'Eapp_vsXA_Info'), handles.Eapp_vsXA_Info = FRET_Data_Struct.Eapp_vsXA_Info; end
    case 'txt'
    otherwise
end
