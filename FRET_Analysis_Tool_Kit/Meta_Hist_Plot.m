function Meta_Hist_Plot(FRET_FigureH)

handles = guidata(FRET_FigureH);

Meta_Hist_FigureH = figure('Name', 'Meta Histogram Plot', 'Tag', 'Meta_Hist_FigureH', 'Position', [400, 400, 800, 600], ...
...
set(MH_Save_Icon, 'ClickedCallback', {@MH_Save_Icon_ClickedCallback, FRET_FigureH}, 'ToolTipString', 'Save Meta Histogram');
MH_Print_Icon = findall(Meta_Hist_FigureH, 'ToolTipString','Print');     % Printing Meta-histogram.
set(MH_Print_Icon, 'ClickedCallback', {@MH_Print_Icon_ClickedCallback, FRET_FigureH}, 'ToolTipString', 'Save Meta Histogram');
...
function MH_Save_Icon_ClickedCallback(hObject, eventdata, FRET_FigureH)
