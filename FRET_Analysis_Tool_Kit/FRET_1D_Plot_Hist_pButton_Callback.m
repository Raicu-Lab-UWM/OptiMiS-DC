...
%------------------------------------------------------------------------------
function FRET_1D_Plot_Hist_pButton_Callback (hObject, eventdata, FRET_FigureH)
...
handles    = guidata(FRET_FigureH);
if isfield(handles, 'Main_FigureH')
    if isvalid(handles.Main_FigureH), mwHandles = guidata(handles.Main_FigureH); else mwHandles = []; end;
else mwHandles = [];
end
