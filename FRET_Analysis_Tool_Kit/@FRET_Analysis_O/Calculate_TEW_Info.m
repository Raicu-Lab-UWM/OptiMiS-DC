...
%         Self.TEW_Eapp(ii) = 1-FDA_L1/Self.TEW_FD(ii);
        ...
        Self.TEW_FA(ii)   = (FAD_L2 - FAD_L1/gD);                                            % of the FRET equations resolves old puzzles and 
        Self.TEW_Eapp(ii) = (1 + (FDA_L1*(1-gA/gD)/(FAD_L1 - FAD_L2*gA))/rQuant_Yield)^(-1); % suggests measurement strategies" EQ. 53, 54 and 45'.
    end
else
