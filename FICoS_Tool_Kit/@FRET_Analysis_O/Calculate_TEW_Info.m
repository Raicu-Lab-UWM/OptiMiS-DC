...
%         Self.TEW_Eapp(ii) = 1-FDA_L1/Self.TEW_FD(ii);
        Self.TEW_FD(ii,1)     = FDA_L1 + rQuant_Yield*FAD_L1;                                    % from Prof. Raicu's paper titled "Ab initio derivation
        Self.TEW_FA(ii,1)     = (FAD_L2 - FAD_L1/gD);                                            % of the FRET equations resolves old puzzles and 
        Self.TEW_FDA_L1(ii,1) = FDA_L1;                                                          % Donor emission at excitation of wavelength 1
        Self.TEW_FAD_L1(ii,1) = FAD_L1;                                                          % Acceptor emission at excitation of wavelength 1
        Self.TEW_FAD_L2(ii,1) = FAD_L2;                                                          % Acceptor emission at excitation of wavelength 2
...
%     Self.TEW_Eapp = 1-FDA_L1/Self.TEW_FD;
