function handles = FICoS_Initiate(handles, FICoS_Obj_Param)

if isfield(FICoS_Obj_Param, 'FICoS_Params'), FICoS_Param = FICoS_Obj_Param.FICoS_Params; else FICoS_Param = []; end;
if isfield(FICoS_Obj_Param, 'Disp_Params'), Disp_Param = FICoS_Obj_Param.Disp_Params; else Disp_Param = []; end;
if isfield(FICoS_Obj_Param, 'General_Params'), General_Param = FICoS_Obj_Param.General_Params; else General_Param = []; end;

if isfield(FICoS_Param,'FICoS_Hist_Bin'), handles.FICoS_Hist_Bin = FICoS_Param.FICoS_Hist_Bin; end;
...
if isfield(FICoS_Param,'FICoS_MetaHist_Bin'), handles.FICoS_MetaHist_Bin = FICoS_Param.FICoS_MetaHist_Bin; end;
...
if isfield(FICoS_Param,'FICoS_nGaussians'), handles.FICoS_nGaussians = FICoS_Param.FICoS_nGaussians; end;
...
if isfield(FICoS_Param,'FICoS_Fit_Method'), handles.FICoS_Fit_Method = FICoS_Param.FICoS_Fit_Method; end;
...
if isfield(FICoS_Param,'FICoS_Fit_Range'), handles.FICoS_Fit_Range = FICoS_Param.FICoS_Fit_Range; end;
...
if isfield(FICoS_Param,'FICoS_Method'), handles.FICoS_Method = FICoS_Param.FICoS_Method; end;
...
if isfield(FICoS_Param,'Calc_2D_FICoS_Switch'), handles.Calc_2D_FICoS_Switch = FICoS_Param.Calc_2D_FICoS_Switch; end;
