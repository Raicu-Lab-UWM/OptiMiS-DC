...
%------------------------------------------------------------------------------
function FICoS_Settings_Icon_Callback(hObject, eventdata)

handles = guidata(hObject);
% Create a figure with no manu bar and no tool bar. The window title is Auto Fit Settings
Setting_FigureH = figure('Name','FICoS Analysis Settings','NumberTitle','off', ...
...
FICoS_Setting_Tab            = uitab(tabgp,'Title','FICoS');
handles.General_Setting_Tab = General_Setting_Tab;
handles.FICoS_Setting_Tab    = FICoS_Setting_Tab;
%-------------------------- Plot Setting Tab --------------------------------------------------------------------------
...
handles = FICoS_General_Setting_Tab_Fcn(handles); guidata(handles.output, handles);
handles = FICoS_Setting_Tab_Fcn(hObject); guidata(handles.output, handles);
