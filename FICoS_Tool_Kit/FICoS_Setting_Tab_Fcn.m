...
%------------------------------------------------------------------------------
function handles = FICoS_Setting_Tab_Fcn(FICoS_FigureH)

handles          = guidata(FICoS_FigureH);

FICoS_Setting_Tab = handles.FICoS_Setting_Tab;

% FICoS histogram bin
FICoS_Hist_Bin_Text = uicontrol('Parent', FICoS_Setting_Tab, 'Style', 'text', 'String', 'Histogram Bin', ...
                              'HorizontalAlignment', 'left', 'Units', 'Pixels', 'Position', [10 300 110 25], 'FontSize', 10);
FICoS_Hist_Bin_Edit = uicontrol('Parent', FICoS_Setting_Tab, 'Style', 'edit', ...
...
FICoS_MetaHist_Bin_Text = uicontrol('Parent', FICoS_Setting_Tab, 'Style', 'text', 'String', 'Meta-Histogram Bin', ...
                              'HorizontalAlignment', 'left', 'Units', 'Pixels', 'Position', [240 300 150 25], 'FontSize', 10);
FICoS_MetaHist_Bin_Edit = uicontrol('Parent', FICoS_Setting_Tab, 'Style', 'edit', ...
...
FICoS_nGaussians_Text = uicontrol('Parent', FICoS_Setting_Tab, 'Style', 'text', 'String', '# Gaussians/Peaks', ...
                           'HorizontalAlignment', 'left', 'Units', 'Pixels', 'Position', [10 260 142 25], 'FontSize', 10);
FICoS_nGaussians_Edit = uicontrol('Parent', FICoS_Setting_Tab, 'Style', 'edit', ...
...
FICoS_Fit_Method_Text = uicontrol('Parent', FICoS_Setting_Tab, 'Style', 'text', 'String', 'Fitting Method', ...
                                   'HorizontalAlignment', 'left', 'Units', 'Pixels', 'Position', [10 220 105 25], 'FontSize', 10);
FICoS_Fit_Method_popMenu = uicontrol('Parent', FICoS_Setting_Tab, 'Style', 'popupmenu', 'String', FICoS_Fit_Method_Menu, ...
                                      'Units', 'Pixels', 'Position', [160 220 180 25], 'FontSize', 10, ...
                                      'Callback', {@FICoS_Fit_Method_popMenu_Callback, handles.output});

% Capp Fitting Range
FICoS_Fit_Range_Text = uicontrol('Parent', FICoS_Setting_Tab, 'Style', 'text', 'String', 'Fitting Range', ...
                           'HorizontalAlignment', 'left', 'Units', 'Pixels', 'Position', [10 180 100 25], 'FontSize', 10);
FICoS_Fit_Range_Edit = uicontrol('Parent', FICoS_Setting_Tab, 'Style', 'edit', ...
...
TEW_FICoS_Analysis_Parameters_Text = uicontrol('Parent', FICoS_Setting_Tab, 'Style', 'text', 'String', '2D FICoS Spectrometry Parameters', ...
                              'HorizontalAlignment', 'left', 'Units', 'Pixels', 'Position', [10 90 261 25], 'FontSize', 10);

SEW_Capp_cBox = uicontrol('Parent', FICoS_Setting_Tab, 'Style', 'checkbox', 'String', 'Use Single Excitation Capp Calc.', ...
...
if length(handles.FOV_List) == 1 && isempty(handles.FOV_List.Name), FICoS_Calculated = 0; elseif isempty(handles.FOV_List), FICoS_Calculated = 0; else FICoS_Calculated = 1; end;
if FICoS_Calculated
    Image_ = [handles.FOV_List.raw_Data];
    if ~isfield(handles, 'FICoS_Fit_Range'), handles.FICoS_Fit_Range = [min(Image_(:)) max(Image_(:))]; elseif isempty(handles.FICoS_Fit_Range), handles.FICoS_Fit_Range = [min(Image_(:)) max(Image_(:))]; end;    
else
    handles.FICoS_Fit_Range = [-1, 1];
end;
...
set(FICoS_Hist_Bin_Edit, 'String', num2str(handles.FICoS_Hist_Bin));
set(FICoS_MetaHist_Bin_Edit, 'String', num2str(handles.FICoS_MetaHist_Bin));
set(FICoS_nGaussians_Edit, 'String', num2str(handles.FICoS_nGaussians));
FICoS_Fit_Method_Index = find(~cellfun(@isempty, strfind(FICoS_Fit_Method_Menu, handles.FICoS_Fit_Method)));
set(FICoS_Fit_Method_popMenu, 'Value', FICoS_Fit_Method_Index);
set(FICoS_Fit_Range_Edit, 'String', num2str(handles.FICoS_Fit_Range));
FICoS_Method_Index = find(~cellfun(@isempty, strfind(FICoS_Method_Menu, handles.FICoS_Method)));
set(FICoS_Method_popMenu, 'Value', FICoS_Method_Index);
set(SEW_Capp_cBox, 'Value', handles.SEW_Capp);
end
...
handles.FICoS_Hist_Bin = str2double(get(hObject, 'String'));
...
handles = guidata(Main_Figure);
handles.FICoS_MetaHist_Bin = str2double(get(hObject, 'String'));
...
handles = guidata(Main_Figure);
handles.FICoS_nGaussians = str2double(get(hObject, 'String'));
...
handles.FICoS_Fit_Method = content{get(hObject, 'Value')};
...
handles = guidata(Main_Figure);
handles.FICoS_Fit_Range = str2num(get(hObject, 'String'));
...
handles = guidata(Main_Figure);
content = get(hObject, 'String');
handles.FICoS_Method = content{get(hObject, 'Value')};
...
handles = guidata(Main_Figure);
handles.SEW_Capp = get(hObject, 'Value');
